---
mode: agent
description: Run /epic-plan — see .github/prompts/epic-plan.prompt.md for the authoritative spec.
...
- `.specs/_stack.json`
- `.github/templates/epic-design.template.md`
- `.github/templates/epic-roadmap.template.md`
