---
mode: agent
description: Run /ship — see .github/prompts/ship.prompt.md for the authoritative spec.
...
- `.github/skills/shipping-and-launch/SKILL.md` (authoritative behavior).
...
5. **Render the ship plan.** Fill `.github/templates/ship-plan.template.md` — every section non-empty (`n/a` allowed only with a one-line reason).
