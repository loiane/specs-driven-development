---
mode: agent
description: Run /onboard — see .github/prompts/onboard.prompt.md for the authoritative spec.
...
4. Diff `$MODULE/pom.xml` against `.github/maven/parent-pom-fragment.xml`; list missing harness layers as Findings.
