---
description: Run /onboard — see .windsurf/workflows/onboard.md for the authoritative spec.
---
# /onboard
...
4. Diff `$MODULE/pom.xml` against `.windsurf/maven/parent-pom-fragment.xml`; list missing harness layers as Findings.
