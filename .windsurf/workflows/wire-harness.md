---
description: Run /wire-harness — see .windsurf/workflows/wire-harness.md for the authoritative spec.
---
# /wire-harness

**Phase:** 0 (meta) — onboarding extension
**Owning agent:** `.windsurf/workflows/spring-onboarding.md`
...
- `.windsurf/maven/parent-pom-fragment.xml` and `.windsurf/skills/maven-harness-pom/SKILL.md` (authoritative reference).
- `.windsurf/skills/jacoco-coverage-policy/SKILL.md`, `.windsurf/skills/pit-mutation-tuning/SKILL.md`, `.windsurf/skills/flyway-or-liquibase-detection/SKILL.md`.
...
6. **Document deferrals.** For each layer deferred in step 2, write `.specs/adr/ADR-NNN-<slug>.md` per `.windsurf/skills/adr-authoring/SKILL.md` (Context, Decision drivers, Considered options, Decision outcome with rationale, Consequences, Trigger to revisit). Add a corresponding `DEBT-NNN` entry to `.specs/_known-debt.md`.
