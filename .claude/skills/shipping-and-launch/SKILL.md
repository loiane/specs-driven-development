...
authoritative_references:
  ...
  - .claude/skills/spring-security-baseline/SKILL.md
  - .claude/skills/flyway-or-liquibase-detection/SKILL.md
---
...
Detect the migration tool with `.claude/skills/flyway-or-liquibase-detection/SKILL.md`. For each migration script in the diff:
...
3. **Fill the template.** Use `.claude/templates/ship-plan.template.md`. Every section must have content; "n/a" is allowed only with a one-line reason.
