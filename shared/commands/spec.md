...
If a ticket is supplied, fetch it via the configured MCP server (see `shared/skills/issue-tracker-ingestion/SKILL.md`) and treat its body as the source.

## Reads
- The supplied text or ticket.
- `.specs/_onboarding.md` (for stack context).
- `shared/templates/01-spec.md`.
- `shared/checklists/spec-review.md` (so the spec is born review-ready).
...
6. Render the file using `shared/templates/01-spec.md`.
