...
**Owning agent:** `shared/agents/spring-test-engineer.md`
...
- `shared/templates/06-test-plan.md`.
...
5. Update the traceability matrix by running `scripts/traceability.sh <feature-id>`.
